...
- 設計
  - 改修箇所の担当で既存のシステムと矛盾が発生しないよう注意し設計を行う。
- コーディング
  - クライアントとサーバーに分ける際に矛盾が発生しないようコーディングを行う。
- バージョン管理
  - svnを使用。
...
### 株式会社SUBARU入社〜退社(2015年10月~2018年3月)
- ラインで車両の製造

### 株式会社東京エレクトロン入社〜退社(2015年3月~2015年9月)
- 半導体装置のメンテナンス

### 株式会社G-MAX入社〜退社(2011年12月~2014年12月)
- ホール業務を担当

### 大分市消防局入社〜退社(2011年4月~2011年11月)
- 消防士に従事
